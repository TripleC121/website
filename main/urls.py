...
urlpatterns = [
    ...
    path('learning/pgp_aiml/ai_foundations', views.ai_foundations, name='ai_foundations'),
    path('learning/pgp_aiml/machine_learning', views.machine_learning, name='machine_learning'),
    path('learning/pgp_aiml/deep_learning', views.deep_learning, name='deep_learning'),
    path('learning/pgp_aiml/course_projects/', views.course_projects, name='course_projects'),
